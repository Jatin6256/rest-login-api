        ...
        else
        {
            var transporter = nodemailer.createTransport({
              ...
              var mailOptions = {
                ...
                text: "Hello,"+"\n\nWelcome to your AMS account  to verify it your email address click on the following link:\n\n"+  'https://signin-rest-api.herokuapp.com/faculty/verify/'+ token + "\nRegards,\nTeam AMS",
              };
...
router.post("/register",(req,res) => { 
    ...
    if(validateEmailAndPassword(req.body.email,req.body.password))
    {
        ...
        res.status(400).json({err: true,msg: "Invalid email or password.Email should be of iiitr domain  and length of password must be atleast 8"});
                    ...
                    else
                    {
                        var transporter = nodemailer.createTransport({
                          ...
                          var mailOptions = {
                            ...
                            text: "Hello,"+"\n\nA forget password Request was generated with your Associated account on AMS to verify it was you click on the following link:\n\n"+'https://signin-rest-api.herokuapp.com/faculty/verifyResetPasswordRequest/'+ tokenNum + "\nRegards,\nTeam AMS",
                          };
